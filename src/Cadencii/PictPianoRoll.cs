            ...
            lock (AppManager.mDrawObjects) {
                ...
                if (AppManager.editorConfig.SkipDrawWhilePlaying && AppManager.isPlaying()) {
                    PortUtil.drawStringEx(
                        g1,
                        "Waveform is hidden while playing. It will reappear automatically.",
                ...
                try {
                    ...
                    Color bar = new Color(129,123,123); //renderer.getPianorollBar();
                    Color beat = new Color(182, 176, 176); //renderer.getPianorollBeat();
