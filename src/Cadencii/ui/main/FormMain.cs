...
namespace cadencii
{
...
#endif
    {
        ...
        private readonly AuthorListEntry[] _CREDIT = new AuthorListEntry[]{
            ...
            new AuthorListEntry(),
            new AuthorListEntry( "lo and behold somebodys actually reading this!", 3 ),
        };
        #endregion
...
//            toolStripTool.remove( getStripBtnStepSequencer() );
        ...
        public Vector<ValuePairOfStringArrayOfKeys> getDefaultShortcutKeys()
        {
            ...
            Vector<ValuePairOfStringArrayOfKeys> ret = new Vector<ValuePairOfStringArrayOfKeys>( Arrays.asList(
                ...
                new ValuePairOfStringArrayOfKeys( menuEditDelete.Name, new Keys[]{ Keys.Delete } ), //Changed 
...
#endif // ENABLE_SCRIPT
 {
...
#endif
            projNameLabel.Text = "Project \"" + file + "\"";
        }
        ...
        {
            pictPianoRoll.invalidate(); //one day the paino roll stopped painting like it should, so i fixed it. 
            lock (AppManager.mDrawObjects) {
                if (mFormActivated) {
#if ENABLE_PROPERTY
...
#else
            try { System.Diagnostics.Process.Start(pdf); }
            catch (Exception) { MessageBox.Show("File does not exist."); }
#endif
        }
 ...
 sender == menuSettingPositionQuantizeOff ) {
        ...
        //Now for real business (this is where my beautiful contribution to this wonderful piece of art begins):

        public bool showMenuBarOnClick = true;

        private void panel2_Paint(object sender, PaintEventArgs e) {
            //Nobody home (yet)
        }

        private void BigMenu_Click(object sender, EventArgs e) {
            toggleBigMenu();
        }

        private void FormMain_Load_1(object sender, EventArgs e) {
            //rebar.Visible = false; 
            toolStripMenuItem7.CheckedChanged += toolStripMenuItem7_CheckedChanged;

            //Get the bottom panel to paint:
            trackSelector.MouseMove += controlTrack_mouseMove;

            //If the system was just installed, setup voicebanks:
            string fileLoc = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\Boare\\installed.cscfg";

            if (!System.IO.File.Exists(fileLoc)) {
                this.Opacity = 0;

                new PrefManager().showPrefs(this, this.Location, true);

                StreamWriter sw = new StreamWriter(fileLoc);
                sw.Write("InstallDateTime: " + DateTime.Now.ToString());
                sw.Close();
        ...
        void toolStripMenuItem7_CheckedChanged(object sender, EventArgs e) {
            panel2.Visible = toolStripMenuItem7.Checked; 
            //Determines if panel2 is a ninja or a plain old control
            menuStripMain.Visible = !toolStripMenuItem7.Checked;
            bigMenu.Visible = false;
        }

        private void SelectBtn_Click(object sender, EventArgs e) {
            stripBtnArrow_Click(null, null);
            highligher.Location = new System.Drawing.Point(73, 27);
        }

        private void addBtn_Click(object sender, EventArgs e) {
            stripBtnPencil_Click(null, null);
            highligher.Location = new System.Drawing.Point(109, 27);
        }

        private void eraseBtn_Click(object sender, EventArgs e) {
            stripBtnEraser_Click(null, null); 
            highligher.Location = new System.Drawing.Point(145, 27);
        }
        ...
        public void toggleBigMenu() {
            ...
            if (bigMenu.Visible) bigMenu.Visible = false;
            else bigMenu.Visible = true;
        ...
        private void label1_Click(object sender, EventArgs e) {
            handleFileNew_Click(null, null);
        }

        private void bigMenu_Paint(object sender, PaintEventArgs e) {
            System.Drawing.Font largeLabelFont = new System.Drawing.Font("Segoe UI", 12);

            projNameLabel.Font = largeLabelFont;

            //setup check boxes:
            checkBox1.Checked = menuVisualControlTrack.Checked;
            checkBox2.Checked = menuVisualMixer.Checked;
            checkBox3.Checked = menuVisualWaveform.Checked;
            checkBox4.Checked = menuVisualOverview.Checked;
        }

        private void label2_Click(object sender, EventArgs e) {
            toggleBigMenu();
            handleFileOpen_Click(null, null);
        }
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e) {
            menuVisualControlTrack.Checked = checkBox1.Checked;
        }
        ...
        private void label9_Click(object sender, EventArgs e) {
            new cadencii.ui.main._boutform().ShowDialog();
        }

        private void vocaloidSequencevsqToolStripMenuItem_Click(object sender, EventArgs e) {
        ...
        System.Drawing.Color mouseOnLabelColor = System.Drawing.Color.FromArgb(26, 155, 167);
        System.Drawing.Color mouseOffLabelColor = System.Drawing.Color.FromArgb(50, 50, 56);

        private void label1_MouseEnter(object sender, EventArgs e) {
            label1.BackColor = mouseOnLabelColor;
        }

        private void label2_MouseEnter(object sender, EventArgs e) {
            label2.BackColor = mouseOnLabelColor;
        }

        private void label3_MouseEnter(object sender, EventArgs e) {
            label3.BackColor = mouseOnLabelColor;
        }

        private void label4_MouseEnter(object sender, EventArgs e) {
            label4.BackColor = mouseOnLabelColor;
        }

        private void label5_MouseEnter(object sender, EventArgs e) {
            label5.BackColor = mouseOnLabelColor;
        }

        private void label6_MouseEnter(object sender, EventArgs e) {
            label6.BackColor = mouseOnLabelColor;
        }

        private void label1_MouseLeave(object sender, EventArgs e) {
            label1.BackColor = mouseOffLabelColor;
        }

        private void label2_MouseLeave(object sender, EventArgs e) {
            label2.BackColor = mouseOffLabelColor;
        }

        private void label3_MouseLeave(object sender, EventArgs e) {
            label3.BackColor = mouseOffLabelColor;
        }

        private void label4_MouseLeave(object sender, EventArgs e) {
            label4.BackColor = mouseOffLabelColor;
        }

        private void label5_MouseLeave(object sender, EventArgs e) {
            label5.BackColor = mouseOffLabelColor;
        }

        private void label6_MouseLeave(object sender, EventArgs e) {
            label6.BackColor = mouseOffLabelColor;
        }

        private void ImportVsqMI_MouseEnter(object sender, EventArgs e) {
            ImportVsqMI.BackColor = mouseOnLabelColor;
        }

        private void ImportUstMI_MouseEnter(object sender, EventArgs e) {
            ImportUstMI.BackColor = mouseOnLabelColor;
        }

        private void ImportUstMI_MouseLeave(object sender, EventArgs e) {
            ImportUstMI.BackColor = System.Drawing.Color.FromArgb(23, 23, 27);
        }

        private void ImportVsqMI_MouseLeave(object sender, EventArgs e) {
            ImportVsqMI.BackColor = System.Drawing.Color.FromArgb(23, 23, 27);
        }
        ...
        private void ImportVsqMI_Click(object sender, EventArgs e) {
            toggleBigMenu();
            menuFileOpenVsq_Click(null, null);
        }

        private void ImportUstMI_Click(object sender, EventArgs e) {
            toggleBigMenu();
            menuFileOpenUst_Click(null, null);
        }
        ...
        private void label4_Click(object sender, EventArgs e) {
            toggleBigMenu();
            handleFileSave_Click(null, null);
        }

        private void ExportVsqMI_Click(object sender, EventArgs e) {
            toggleBigMenu();
            menuFileExportVsq_Click(null, null);
        }

        private void ExportUstMI_Click(object sender, EventArgs e) {
            toggleBigMenu();
            menuFileExportUst_Click(null, null);
        }

        private void ExportVsqMI_MouseEnter(object sender, EventArgs e) {
            ExportVsqMI.BackColor = mouseOnLabelColor;
        }

        private void ExportVsqMI_MouseLeave(object sender, EventArgs e) {
            ExportVsqMI.BackColor = System.Drawing.Color.FromArgb(23, 23, 27);
        }

        private void ExportUstMI_MouseEnter(object sender, EventArgs e) {
            ExportUstMI.BackColor = mouseOnLabelColor;
        }

        private void ExportUstMI_MouseLeave(object sender, EventArgs e) {
            ExportUstMI.BackColor = System.Drawing.Color.FromArgb(23, 23, 27);
        }

        private void label5_Click(object sender, EventArgs e) {
            toggleBigMenu();
            menuFileSaveNamed_Click(null, null);
        }
        ...
        //Fix a stupid paint bug that popped outta nowhere one day:
        private void vScroll_ValueChanged_1(object sender, EventArgs e) {
            picturePositionIndicator.Invalidate();
            pictPianoRoll.invalidate();
            trackSelector.Invalidate();
        }

        private void hScroll_ValueChanged_1(object sender, EventArgs e) {
            pictPianoRoll.invalidate();
            picturePositionIndicator.Invalidate();
            trackSelector.Invalidate();
        }
